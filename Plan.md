...
Ожидаемый результат: появляется сообщение: «Успешно Операция одобрена Банком.», в базу данных сохранена информация о покупке.
...
Ожидаемый результат: появляется сообщение: «Успешно Операция одобрена Банком.».», в базу данных сохранена информация о покупке в кредит.
